        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-12 md:gap-6">
          ...
          <motion.div {...fade} className="order-first md:order-2 flex justify-center">
            <div className="relative w-60 sm:w-72">
              ...
              {bouquetImage && (
                <img src={bouquetImage} alt="" aria-hidden className="absolute -left-12 sm:-left-16 -bottom-12 w-24 sm:w-28 object-contain pointer-events-none" style={{ transform: 'scaleX(-1) rotate(12deg) translateX(-12px) translateY(-13px)', transformOrigin: 'bottom center' }} />
              )}
              {ringsImage && (
